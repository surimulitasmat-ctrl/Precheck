  ...
  const ICONS = {
    box: `
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <path d="M21 8.5 12 3 3 8.5 12 14l9-5.5Z"></path>
        <path d="M21 8.5V16l-9 5-9-5V8.5"></path>
    ...
    snow: `
      <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <path d="M6 6l2.5 1.5"></path>
        <path d="M18 6l-2.5 1.5"></path>
        <path d="M6 18l2.5-1.5"></path>
        <path d="M18 18l-2.5-1.5"></path>
      </svg>
    `,
    leaf: `
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <path d="M20 4c-8 0-14 6-14 14"></path>
        <path d="M20 4c0 10-6 16-16 16"></path>
        <path d="M7 13c2 0 4-1 6-3"></path>
      </svg>
    `,
    bottle: `
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <path d="M10 2h4"></path>
        <path d="M10 2v3l-1 2v3c0 1-1 2-1 3v6a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2v-6c0-1-1-2-1-3V7l-1-2V2"></path>
        <path d="M9 10h6"></path>
      </svg>
    `,
    counter: `
    ...
    fridge: `
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <path d="M7 2h10a2 2 0 0 1 2 2v18"></path>
        <path d="M5 22V4a2 2 0 0 1 2-2"></path>
    ...
    sandwich: `
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <path d="M4 10c0-2 2-4 8-4s8 2 8 4"></path>
        <path d="M5 10l1 9h12l1-9"></path>
        <path d="M7 14h10"></path>
        <path d="M8 6c1-2 3-3 4-3s3 1 4 3"></path>
      </svg>
    `,
  };

  // Tile config: color + svg key
  const TILE_META = {
